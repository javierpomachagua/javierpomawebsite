  ...
  <section class='mt-10 portfolio md:mt-0'>
    <div class='py-14 bg-blue-100-jp'>
      <div class='max-w-6xl mx-auto'>
        ...
        <p class='px-12 mt-6 text-white text-xl'>
          Además de los proyectos que he trabajo en compañías también hago aplicaciones de manera independiente.
          <br>
          Estos son algunos proyectos que he podido trabajar de manera freelance.
        </p>
